...
if ( count($EM_Tickets->tickets) == 0 ) {
	...
	$BHAA_tickets[0]->ticket_name = "Day Member";
	$BHAA_tickets[0]->ticket_price = $BHAA_Payments[day];
	$BHAA_tickets[0]->ticket_min = 0;
	...
	$BHAA_tickets[1]->ticket_name = "Annual Member";
	$BHAA_tickets[1]->ticket_price = $BHAA_Payments[annual];
	$BHAA_tickets[1]->ticket_min = 0;
	...
	//! TICKET 3
	/*
	$BHAA_tickets[2] = new EM_Ticket();
	$BHAA_tickets[2]->ticket_name = "Inactive Member";
	$BHAA_tickets[2]->ticket_price = $BHAA_Payments[inactive];
	$BHAA_tickets[2]->ticket_min = 0;
	$BHAA_tickets[2]->ticket_max = 1;
	$BHAA_tickets[2]->ticket_start = $EM_Event->event_start_date;
	$BHAA_tickets[2]->ticket_end = $EM_Event->event_end_date;
	$BHAA_tickets[2]->ticket_spaces_limit = 1000;
*/				  
...
<p><em><?php _e('You can have single or multiple tickets, where certain tickets become availalble under certain conditions, e.g. early bookings, group discounts, maximum bookings per ticket, etc.', 'dbem'); ?> <?php _e('Basic HTML is allowed in ticket labels and descriptions.', 'dbem'); ?> <hr />Make sure there are both 'Day Member' AND 'Annual Member' tickets here.<br />If this is an annual membership, make sure there is a ticket called 'Annual Membership'</em></p>
