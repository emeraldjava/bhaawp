...
<span style='font-size: 14pt;'>All Race Numbers are embedded with an electronic chip that records your race time. </span>
...
<p class='none'><span style='font-size: 14pt;'>Your time stops when you pass over the Finish line timing mat.  </span></p>
