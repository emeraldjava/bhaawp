...
require_once(BHAA_PLUGIN_DIR.'/admin/IAdminPage.php');
require_once(BHAA_PLUGIN_DIR.'/admin/class-registrar-admin.php');
...
require_once(BHAA_PLUGIN_DIR.'/public/includes/class-runnersearch-widget.php');
// model
...
require_once(BHAA_PLUGIN_DIR.'/includes/model/class-league-factory.php');
require_once(BHAA_PLUGIN_DIR.'/includes/model/class-abstract-league.php');
